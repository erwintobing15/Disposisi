...
public class SPKeluarModel {
    ...
    public class SPKeluarDataModel extends MessageModel {
        private List<SPKeluarModel> results;

        public List<SPKeluarModel> getResults() {
            return results;
        }

        public void setResults(List<SPKeluarModel> results) {
