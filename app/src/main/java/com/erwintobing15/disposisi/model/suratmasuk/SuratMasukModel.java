package com.erwintobing15.disposisi.model.suratmasuk;
...
public class SuratMasukModel {
    ...
    public class SuratMasukDataModel extends MessageModel {
        private List<SuratMasukModel> results;

        public List<SuratMasukModel> getResults() {
            return results;
        }

        public void setResults(List<SuratMasukModel> results) {
