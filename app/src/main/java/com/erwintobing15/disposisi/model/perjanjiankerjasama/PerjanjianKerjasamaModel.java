package com.erwintobing15.disposisi.model.perjanjiankerjasama;

import com.erwintobing15.disposisi.model.message.MessageModel;

import java.util.List;

public class PerjanjianKerjasamaModel {
    ...
    public class PerjanjianKerjasamaDataModel extends MessageModel {
        private List<PerjanjianKerjasamaModel> results;

        public List<PerjanjianKerjasamaModel> getResults() {
            return results;
        }

        public void setResults(List<PerjanjianKerjasamaModel> results) {
