package com.erwintobing15.disposisi.model.suratkeputusan;

import com.erwintobing15.disposisi.model.message.MessageModel;

import java.util.List;

public class SuratKeputusanModel {
    ...
    public class SuratKeputusanDataModel extends MessageModel {
        private List<SuratKeputusanModel> results;

        public List<SuratKeputusanModel> getResults() {
            return results;
        }

        public void setResults(List<SuratKeputusanModel> results) {
