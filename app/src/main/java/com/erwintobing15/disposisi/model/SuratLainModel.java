...
public class SuratLainModel {
    ...
    public class SuratLainDataModel extends MessageModel {
        private List<SuratLainModel> results;

        public List<SuratLainModel> getResults() {
            return results;
        }

        public void setResults(List<SuratLainModel> results) {
