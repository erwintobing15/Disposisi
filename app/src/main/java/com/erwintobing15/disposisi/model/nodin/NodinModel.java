package com.erwintobing15.disposisi.model.nodin;

import com.erwintobing15.disposisi.model.message.MessageModel;

import java.util.List;

public class NodinModel {
    ...
    public class NodinDataModel extends MessageModel {
        private List<NodinModel> results;

        public List<NodinModel> getResults() {
            return results;
        }

        public void setResults(List<NodinModel> results) {
