package com.erwintobing15.disposisi.model.suratkeluar;
...
public class SuratKeluarModel {
    ...
    public class SuratKeluarDataModel extends MessageModel {
        private List<SuratKeluarModel> results;

        public List<SuratKeluarModel> getResults() {
            return results;
        }

        public void setResults(List<SuratKeluarModel> results) {
