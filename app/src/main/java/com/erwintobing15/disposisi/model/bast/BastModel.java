package com.erwintobing15.disposisi.model.bast;
...
public class BastModel {
    ...
    public class BastDataModel extends MessageModel {
        private List<BastModel> results;

        public List<BastModel> getResults() {
            return results;
        }

        public void setResults(List<BastModel> results) {
