package com.erwintobing15.disposisi.model.agendamou;

import com.erwintobing15.disposisi.model.message.MessageModel;

import java.util.List;

public class AgendaMouModel {
    ...
    public class AgendaMouDataModel extends MessageModel {
        private List<AgendaMouModel> results;

        public List<AgendaMouModel> getResults() {
            return results;
        }

        public void setResults(List<AgendaMouModel> results) {
