package com.erwintobing15.disposisi.model.suratperintah;
...
public class SuratPerintahModel {
    ...
    public class SuratPerintahDataModel extends MessageModel {
        private List<SuratPerintahModel> results;

        public List<SuratPerintahModel> getResults() {
            return results;
        }

        public void setResults(List<SuratPerintahModel> results) {
