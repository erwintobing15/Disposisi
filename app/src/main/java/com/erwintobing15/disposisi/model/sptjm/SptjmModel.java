package com.erwintobing15.disposisi.model.sptjm;

import com.erwintobing15.disposisi.model.message.MessageModel;

import java.util.List;

public class SptjmModel {
    ...
    public class SptjmDataModel extends MessageModel {
        private List<SptjmModel> results;

        public List<SptjmModel> getResults() {
            return results;
        }

        public void setResults(List<SptjmModel> results) {
