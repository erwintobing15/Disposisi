...
public class InsertSptjmActivity extends AppCompatActivity implements Imageutils.ImageAttachmentListener, View.OnClickListener {
    ...
    private void initToolbar() {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Tambah SPTJM");
    ...
    private void saveSptjm() {
        ...
        final String idUser = SessionUtils.getLoggedUser(InsertSptjmActivity.this).getId();
        ...
        if (noAgenda.isEmpty() || tujuan.isEmpty() || noSurat.isEmpty() || isi.isEmpty() || tglSurat.isEmpty() || ket.isEmpty()) {
            ...
            Toast.makeText(InsertSptjmActivity.this, "Silahkan lengkapi data", Toast.LENGTH_SHORT).show();

        } else {

            if (fileImage==null && filePdf==null && fileDocx==null) {

                Call<MessageModel> call = APIService.Factory.create().postInsertSptjm(requestBodyNoAgenda, requestBodyTujuan,
                ...
                call.enqueue(new Callback<MessageModel>() {
                    ...
                    public void onResponse(Call<MessageModel> call, Response<MessageModel> response) {
                        progressDialog.dismiss();
                        Toast.makeText(InsertSptjmActivity.this, "Berhasil menyimpan, refresh layar", Toast.LENGTH_SHORT).show();
    ...
    public boolean checkPermission(String permission, int requestCode) {
        if (ContextCompat.checkSelfPermission(InsertSptjmActivity.this, permission) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(InsertSptjmActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PDF_STORAGE_PERMISSION_CODE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                filePdf = FileUtil.from(InsertSptjmActivity.this, uri);
        ...
        if (requestCode == DOCX_STORAGE_PERMISSION_CODE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                fileDocx = FileUtil.from(InsertSptjmActivity.this, uri);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PDF_STORAGE_PERMISSION_CODE) {
            if (grantResults.length > 0
                ...
                Toast.makeText(InsertSptjmActivity.this,
    ...
    public void onClick(View v) {
        ...
        if (v == buttonSimpan) {
            progressDialog = ProgressDialog.show(InsertSptjmActivity.this, "", "Menyimpan.....", true, true);
            saveSptjm();
        }
