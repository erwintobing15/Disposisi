...
public class UpdateBastActivity extends AppCompatActivity implements Imageutils.ImageAttachmentListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(UpdateBastActivity.this, "", "Load Data.....", true, false);
    ...
    private void initToolbar() {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Ubah surat BAST");
    ...
    private void updateBast() {
        ...
        if (noAgenda.isEmpty() || tujuan.isEmpty() || noSurat.isEmpty() || isi.isEmpty() || tglSurat.isEmpty() || ket.isEmpty()) {
            ...
            progressDialog.dismiss();
            Toast.makeText(UpdateBastActivity.this, "Silahkan lengkapi data", Toast.LENGTH_SHORT).show();

        } else {

            if (fileImage==null && filePdf==null && fileDocx==null) {

                Call<MessageModel> call = APIService.Factory.create().updateBast(requestBodyId, requestBodyNoAgenda, requestBodyTujuan,
                ...
                call.enqueue(new Callback<MessageModel>() {
                    ...
                    public void onResponse(Call<MessageModel> call, Response<MessageModel> response) {
                        progressDialog.dismiss();
                        Toast.makeText(UpdateBastActivity.this, "Berhasil mengubah, silahkan refresh layar", Toast.LENGTH_SHORT).show();
    ...
    public boolean checkPermission(String permission, int requestCode) {
        if (ContextCompat.checkSelfPermission(UpdateBastActivity.this, permission) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(UpdateBastActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PDF_STORAGE_PERMISSION_CODE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                filePdf = FileUtil.from(UpdateBastActivity.this, uri);
        ...
        if (requestCode == DOCX_STORAGE_PERMISSION_CODE && resultCode == RESULT_OK && data != null) {
            ...
            try {
                fileDocx = FileUtil.from(UpdateBastActivity.this, uri);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PDF_STORAGE_PERMISSION_CODE) {
            if (grantResults.length > 0
                ...
                Toast.makeText(UpdateBastActivity.this,
    ...
    public void onClick(View v) {
        ...
        if (v == buttonSimpan) {
            progressDialog = ProgressDialog.show(UpdateBastActivity.this, "", "Menyimpan.....", true, true);
            updateBast();
        }
